...
public class BoxFileCanvas extends Canvas {
	...
	private float scale;
	private ListModel<Symbol> symbols;
	...
	public void setSymbols(ListModel<Symbol> symbols, int selectedIndex) {
	...
	private void drawSymbolBox(final Graphics2D g, final Symbol symbol, final float scale, final boolean isSelected) {
